...
export default async function Calendario({ data }) {
  ...
  return (
    <div className='container__calendario' style={{ marginTop: '89px' }}>
      <main>
        ...
        <section className='section__calendario'>
          <h3 className='title__calendario'>Abril 09</h3>
          <div>
