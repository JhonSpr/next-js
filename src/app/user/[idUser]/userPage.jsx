              ...
              <section>
                ...
                <div className='last__child'>
                  <div className='file-input-container'>
                    <input
                      className='block w-full text-sm text-gray-900 border rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:placeholder-gray-400 input__file'
